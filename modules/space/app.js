window.onload = function() {
    ...
    loader.load('./moonmap.jpg', function(image) {
    ...
    loader.load('./map.png', function(image) {
        ...
        loader.load('./glow.png', function(image) {
            ...
            loader.load('./original.png', function(image) {
    ...
    loader.load('./space.jpg', function(image) {
    ...
    loader.load('./lensflare0.png', function(flare0) {
        loader.load('./lensflare2.png', function(flare2) {
            loader.load('./lensflare3.png', function(flare3) {
